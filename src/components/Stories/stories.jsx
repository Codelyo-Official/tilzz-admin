...
{title:"Hamza First Story",
    img:"https://images.pexels.com/photos/3218465/pexels-photo-3218465.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    follow:true
},
...
function Stories({children}) {
    ...
    return (
        ...
        <a href="" className="btn text-white" style={{backgroundColor:"#4F46E5"}}>View All Stories</a>
        <a href="" className="btn " style={{color:"#4F46E5", backgroundColor:"white", marginLeft:"10px"}}>Create New Story</a>
    </div>
    <div className="logged-in-user-story-div">
        <h2 className="heading-your-story">Your Stories <x-fas-magic style={{height:"14px", width:"14px", display:"inline-block", margin:"0", color:"#4F46E5"}} /></h2>
                ...
                <ul className="story-box101">
                    {FeedStories.map((st,index)=>{
                        return(
                            ...
                            <img src={st.img} alt=""/>
                            <div className="title">
                                <p >{ st.title }</p> <button className={st.follow?"following-btn":"follow-btn"}>{st.follow?"following":"follow"}</button>
                            </div>
                        </li>
                        )
                    })}
